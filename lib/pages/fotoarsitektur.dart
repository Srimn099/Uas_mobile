...
class FotoarsitekturPage extends StatelessWidget {
  const FotoarsitekturPage({super.key});

  @override
  Widget build(BuildContext context) {
    // Daftar path foto
    final List<String> fotoPaths = [
      'assets/images/fotoarsitektur/1.png',
      'assets/images/fotoarsitektur/2.png',
      'assets/images/fotoarsitektur/3.png',
      'assets/images/fotoarsitektur/4.png',
    ];

    return Scaffold(
      appBar: AppBar(
        title: const Text('Foto Arsitektur'),
