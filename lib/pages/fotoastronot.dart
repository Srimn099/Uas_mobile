...
class FotoastronotPage extends StatelessWidget {
  const FotoastronotPage({super.key});

  @override
  Widget build(BuildContext context) {
    // Daftar path foto
    final List<String> fotoPaths = [
      'assets/images/fotoastronot/1.png',
      'assets/images/fotoastronot/2.png',
      'assets/images/fotoastronot/3.png',
      'assets/images/fotoastronot/4.png',
    ];

    return Scaffold(
      appBar: AppBar(
        title: const Text('Foto Astronot'),
