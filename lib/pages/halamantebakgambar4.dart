...
class Halamantebakgambar4Page extends StatefulWidget {
  const Halamantebakgambar4Page({super.key});

  @override
  State<Halamantebakgambar4Page> createState() =>
      _Halamantebakgambar4PageState();
}

class _Halamantebakgambar4PageState extends State<Halamantebakgambar4Page> {
  ...
  void _goToNextPage() {
    Navigator.push(
      context,
      MaterialPageRoute(
        builder: (context) => const MainPage(), // Halaman berikutnya
      ),
    );
  }
      ...
      body: SingleChildScrollView(
        child: Padding(
          ...
          child: Column(
            ...
            children: [
              Image.asset(
                'assets/images/tebakgambar/4.png', // Path file gambar
                fit: BoxFit.contain,
              ),
              const SizedBox(height: 20),
              TextField(
