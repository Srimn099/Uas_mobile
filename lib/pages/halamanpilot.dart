...
import 'package:pengenalanprofesi/pages/fotopilot.dart';

class HalamanpilotPage extends StatefulWidget {
  const HalamanpilotPage({super.key});

  @override
  State<HalamanpilotPage> createState() => _HalamanpilotPageState();
}

class _HalamanpilotPageState extends State<HalamanpilotPage> {
  @override
        ...
        child: Padding(
          ...
          child: Column(
            ...
            children: [
              ...
              const Text(
                'Pilot bertugas mengemudikan pesawat dan membawa kita terbang ke tempat-tempat yang jauh. ',
              ...
              ElevatedButton(
                onPressed: () {
                  ...
                  Navigator.push(
                    context,
                    MaterialPageRoute(
                        builder: (context) => const FotopilotPage()),
                  );
                },
