...
class FototentaraPage extends StatelessWidget {
  const FototentaraPage({super.key});

  @override
  Widget build(BuildContext context) {
    // Daftar path foto
    final List<String> fotoPaths = [
      'assets/images/fototentara/1.png',
      'assets/images/fototentara/2.png',
      'assets/images/fototentara/3.png',
      'assets/images/fototentara/4.png',
    ];

    return Scaffold(
      appBar: AppBar(
        title: const Text('Foto Tentara'),
