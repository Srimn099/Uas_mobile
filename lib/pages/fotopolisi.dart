...
class FotopolisiPage extends StatelessWidget {
  const FotopolisiPage({super.key});

  @override
  Widget build(BuildContext context) {
    // Daftar path foto
    final List<String> fotoPaths = [
      'assets/images/fotopolisi/1.png',
      'assets/images/fotopolisi/2.png',
      'assets/images/fotopolisi/3.png',
      'assets/images/fotopolisi/4.png',
    ];

    return Scaffold(
      appBar: AppBar(
        title: const Text('Foto Polisi'),
