...
class FotonahkodaPage extends StatelessWidget {
  const FotonahkodaPage({super.key});

  @override
  Widget build(BuildContext context) {
    // Daftar path foto
    final List<String> fotoPaths = [
      'assets/images/fotonahkoda/1.png',
      'assets/images/fotonahkoda/2.png',
      'assets/images/fotonahkoda/3.png',
      'assets/images/fotonahkoda/4.png',
    ];

    return Scaffold(
      appBar: AppBar(
        title: const Text('Foto Nakoda'),
