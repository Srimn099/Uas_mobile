...
class FotodokterPage extends StatelessWidget {
  const FotodokterPage({super.key});

  @override
  Widget build(BuildContext context) {
    // Daftar path foto
    final List<String> fotoPaths = [
      'assets/images/fotodokter/1.png',
      'assets/images/fotodokter/2.png',
      'assets/images/fotodokter/3.png',
      'assets/images/fotodokter/4.png',
    ];

    return Scaffold(
      appBar: AppBar(
        title: const Text('Foto Dokter'),
