...
class FotodamkarPage extends StatelessWidget {
  const FotodamkarPage({super.key});

  @override
  Widget build(BuildContext context) {
    // Daftar path foto
    final List<String> fotoPaths = [
      'assets/images/fotodamkar/1.png',
      'assets/images/fotodamkar/2.png',
      'assets/images/fotodamkar/3.png',
      'assets/images/fotodamkar/4.png',
    ];

    return Scaffold(
      appBar: AppBar(
        title: const Text('Foto Damkar'),
