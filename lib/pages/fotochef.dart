...
class FotochefPage extends StatelessWidget {
  const FotochefPage({super.key});

  @override
  Widget build(BuildContext context) {
    // Daftar path foto
    final List<String> fotoPaths = [
      'assets/images/fotochef/1.png',
      'assets/images/fotochef/2.png',
      'assets/images/fotochef/3.png',
      'assets/images/fotochef/4.png',
    ];

    return Scaffold(
      appBar: AppBar(
        title: const Text('Foto Chef'),
