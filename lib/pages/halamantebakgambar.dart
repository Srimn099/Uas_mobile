...
import 'halamantebakgambar2.dart'; // Pastikan halaman berikutnya sudah di-import

class HalamantebakgambarPage extends StatefulWidget {
  const HalamantebakgambarPage({super.key});

  @override
  State<HalamantebakgambarPage> createState() => _HalamantebakgambarPageState();
}

class _HalamantebakgambarPageState extends State<HalamantebakgambarPage> {
  ...
  void _goToNextPage() {
    Navigator.push(
      ...
      MaterialPageRoute(
        builder: (context) =>
            const Halamantebakgambar2Page(), // Halaman berikutnya
      ),
    );
  }
      ...
      body: SingleChildScrollView(
        child: Padding(
          ...
          child: Column(
            ...
            children: [
              Image.asset(
                'assets/images/tebakgambar/1.png', // Path file gambar
                fit: BoxFit.contain,
              ),
              const SizedBox(height: 20),
              TextField(
