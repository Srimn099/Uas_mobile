...
class FotopeternakPage extends StatelessWidget {
  const FotopeternakPage({super.key});

  @override
  Widget build(BuildContext context) {
    // Daftar path foto
    final List<String> fotoPaths = [
      'assets/images/fotopeternak/1.png',
      'assets/images/fotopeternak/2.png',
      'assets/images/fotopeternak/3.png',
      'assets/images/fotopeternak/4.png',
    ];

    return Scaffold(
      appBar: AppBar(
        title: const Text('Foto Peternak'),
