import 'package:pengenalanprofesi/pages/halamantebakgambar3.dart';
import 'package:flutter/material.dart';
// Pastikan halaman berikutnya sudah di-import

class Halamantebakgambar2Page extends StatefulWidget {
  const Halamantebakgambar2Page({super.key});

  @override
  State<Halamantebakgambar2Page> createState() =>
      _Halamantebakgambar2PageState();
}

class _Halamantebakgambar2PageState extends State<Halamantebakgambar2Page> {
  ...
  void _goToNextPage() {
    Navigator.push(
      ...
      MaterialPageRoute(
        builder: (context) =>
            const Halamantebakgambar3Page(), // Halaman berikutnya
      ),
    );
  }
      ...
      body: SingleChildScrollView(
        child: Padding(
          ...
          child: Column(
            ...
            children: [
              Image.asset(
                'assets/images/tebakgambar/2.png', // Path file gambar
                fit: BoxFit.contain,
              ),
              const SizedBox(height: 20),
              TextField(
